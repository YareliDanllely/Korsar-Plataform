    ...
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
      ...
      >
        <g clipPath="url(#a)">
          ...
          <g
            id="torre"
            onMouseEnter={(e) => showTooltip("Torre", colors.torre, e)}
            onMouseLeave={hideTooltip}
            style={{ cursor: 'pointer' }}
          >
            <path
              fill={colors.torre || "#F1F1F1"}
          ...
          <g
            id="nacelle"
            onMouseEnter={(e) => showTooltip("Nacelle", colors.nacelle, e)}
            onMouseLeave={hideTooltip}
            style={{ cursor: 'pointer' }}
          >
            <path
              fill={colors.nacelle || "#E5E5E5"}
          ...
          <g
            id="heliceA"
            onMouseEnter={(e) => showTooltip("Hélice A", colors.heliceA, e)}
            onMouseLeave={hideTooltip}
            style={{ cursor: 'pointer' }}
          >
            <path
              fill={colors.heliceA || "#F1F1F1"}
          ...
          <g
            id="heliceB"
            onMouseEnter={(e) => showTooltip("Hélice B", colors.heliceB, e)}
            onMouseLeave={hideTooltip}
            style={{ cursor: 'pointer' }}
          >
            <path
              fill={colors.heliceB || "#F1F1F1"}
          ...
          <g
            id="heliceC"
            onMouseEnter={(e) => showTooltip("Hélice C", colors.heliceC, e)}
            onMouseLeave={hideTooltip}
            style={{ cursor: 'pointer' }}
          >
            <path
              fill={colors.heliceC || "#F1F1F1"}
