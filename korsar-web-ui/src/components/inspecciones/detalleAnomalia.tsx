 ...
 return (
    <div className="flex flex-col justify-items-start space-y-6">
        ...
        <div className="flex flex-col gap-2s">
                ...
                <h2 className="text-sm text-korsar-text-1">{informacionAnomalia.codigo_anomalia}</h2>
        ...
        <div>
            <p className="text-2xl font-medium text-korsar-negro-90">Tipo Componente</p>
            <h2  className="text-sm text-korsar-text-1">{informacionAnomalia.ubicacion_componente}</h2>
        </div>
        ...
        <div>
            ...
            <h2 className="text-sm text-korsar-text-1">{informacionAnomalia.severidad_anomalia}</h2>
        </div>

        <hr className="my-4 border-l-korsar-text-2" />
        <div>
            <p className="text-2xl font-medium text-korsar-negro-90">Orientacion </p>
            <h2 className="text-sm text-korsar-text-1">{informacionAnomalia.orientacion_anomalia}</h2>
        </div>
        ...
        <div>
            ...
            <h2 className="text-sm text-korsar-text-1">{informacionAnomalia.descripcion_anomalia}</h2>
        </div>
